...
export class AppComponent implements OnInit, OnDestroy {
  ...
  public async ngOnInit() {
    try {
      ...
      this.userProfile = await this.authService.getUserData('vultrack');        
    } catch (error) {
  ...
  async setPayload() {
    ...
    this.subs.sink = (await this.userService.getCurrentUser()).subscribe({
      next: (response: any) => {
        ...
        this.user.isAdmin ? this.userRole = 'VUL-TRACK Admin' : this.userRole = 'VUL-TRACK User';
