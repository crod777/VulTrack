...
@Component({
  selector: 'vultrack-admin-processing',
  ...
  statusCards = [
    {
      ...
      type: 'primary',
      component: 'vultrack-user-processing',
    },
    {
      title: 'Collection Management',
      icon: { icon: 'archive-outline' },
      type: 'success',
      component: 'vultrack-collection-processing',
    },
    {
      title: 'STIG Manager',
      icon: { icon: 'flag-outline' },
      type: 'info',
      component: 'vultrack-stigmanager-admin',
    },
    {
